function [testFit,param,variables,AllMaxLLHShifts] = create_glm(posfile,spikefile,filt_eeg,sampleRate,boxSize)
...
posx_c = mean([posx posx2],2); posy_c = mean([posy posy2],2); % compute average position
...
[allModelFits, bestModels, bestModelFits, parameters, pvals, final_pval] = forward_search_kfoldShift(A,spiketrain,train_ind,test_ind);
