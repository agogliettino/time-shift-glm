...
for k = 1:numFolds
    ...
    r = exp(test_A * param); n = reshape(test_spikes,numel(test_spikes),1); meanFR_test = nanmean(test_spikes); 
    ...
    r_train = exp(train_A * param); n_train = reshape(train_spikes,numel(train_spikes),1); meanFR_train = nanmean(train_spikes);   
